...
/**
 * Plan a follow-up visit originating from a consultation.
 */
...
public record CreateFollowUpRequest(
        ...
        /** Optional explicit scheduling doctor; defaults to consultation attending doctor. */
        UUID doctorId,

        /** Optional link to a booked follow-up appointment. */

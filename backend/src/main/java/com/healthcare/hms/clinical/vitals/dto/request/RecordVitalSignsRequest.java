...
import com.healthcare.hms.clinical.vitals.validation.ValidVitalSignsMeasurement;
...
/**
 * Record a new vital-signs measurement during a consultation.
 *
 * <p>Each POST appends an immutable history row — vitals are never overwritten in place.
 * At least one clinical measurement must be supplied. BMI is computed server-side when
 * height and weight are both present.
 */
@ValidVitalSignsMeasurement

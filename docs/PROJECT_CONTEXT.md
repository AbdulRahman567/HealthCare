...
| Patient security review             | Tenant/RBAC/PHI/audit hardening; soft-delete + critical allergy guards; no Critical left | Phase 5.9; see [PATIENT_MANAGEMENT.md](./PATIENT_MANAGEMENT.md)                                                    |
| Patient production readiness        | Lifecycle verification, national-ID unique, allergy flag patch semantics, FE chart UX    | Phase 5.10; see [PATIENT_MANAGEMENT.md](./PATIENT_MANAGEMENT.md)                                                   |
| Appointment security review         | Tenant/RBAC/audit/doctor-scope/patient-portal hardening; no Critical remaining           | Phase 6.9; see [PROJECT_CONTEXT.md](./PROJECT_CONTEXT.md) / Appointment module docs                               |
| Appointment production readiness    | Lifecycle/queue integrity, booking locks, availability UI, Flyway V32; no Critical/High  | Phase 6.10                                                                                                        |
| Clinical Workflow domain            | `clinical` module; Consultation + Diagnosis + ClinicalNote + VitalSigns + FollowUp; V33 | Phase 7.1; see [CLINICAL_WORKFLOW.md](./CLINICAL_WORKFLOW.md)                                                        |
| Consultation management             | Lifecycle APIs, clinical documentation, audit logging, doctor scope; Flyway V34         | Phase 7.2; see [CLINICAL_WORKFLOW.md](./CLINICAL_WORKFLOW.md)                                                        |
| Vital signs                         | Append-only measurements, patient time-series history, BMI, clinical range validation   | Phase 7.3; see [CLINICAL_WORKFLOW.md](./CLINICAL_WORKFLOW.md)                                                        |
| Diagnosis & follow-up               | Structured encounter diagnoses (ICD-10, primary guard) + follow-up planning APIs         | Phase 7.4; see [CLINICAL_WORKFLOW.md](./CLINICAL_WORKFLOW.md)                                                        |
| Prescription management             | `prescriptions` module; Prescription + items; issue/cancel; duplicate medicine guard; V35 | Phase 7.5; see [CLINICAL_WORKFLOW.md](./CLINICAL_WORKFLOW.md)                                                        |
| Clinical notes & attachments        | SOAP/progress/procedure/discharge notes; image/PDF attachments; S3/MinIO storage abstraction; V36 | Phase 7.6; see [CLINICAL_WORKFLOW.md](./CLINICAL_WORKFLOW.md)                                                        |
| Follow-up management                | Clinical recommendations, due-list APIs, timeline SPI (`FOLLOW_UP`), reminder-ready fields; V37  | Phase 7.7; see [CLINICAL_WORKFLOW.md](./CLINICAL_WORKFLOW.md)                                                        |
| Clinical Workflow UI                | Next.js consultation workspace: vitals, diagnosis, Rx, notes, timeline, follow-ups; drafts + RBAC | Phase 7.8; see [CLINICAL_WORKFLOW.md](./CLINICAL_WORKFLOW.md)                                                        |
| Clinical security review            | Tenant/RBAC/doctor-scope/PHI/audit/attachment hardening; no Critical remaining                   | Phase 7.9; see [CLINICAL_WORKFLOW.md](./CLINICAL_WORKFLOW.md)                                                        |
| Clinical production readiness       | Queue↔chart sync, cancel, VISIT/Rx timeline, V38 uniqueness; no Critical/High remaining          | Phase 7.10; see [CLINICAL_WORKFLOW.md](./CLINICAL_WORKFLOW.md)                                                       |
| Medical Records (longitudinal)      | Family history + Phase 5 history/allergies/vaccines/timeline; Flyway V39; no Critical/High       | Phase 8; see [PATIENT_MANAGEMENT.md](./PATIENT_MANAGEMENT.md)                                                        |
| Prescription Management (Phase 9)   | Printable Rx UI, patient Rx history tab, cancel/issue gates, issue consult checks; no Critical/High | Phase 9; see [CLINICAL_WORKFLOW.md](./CLINICAL_WORKFLOW.md)                                                        |
| Local ops / env hardening           | Aligned `.env.example`s, Spring dotenv loader, `prod` profile JWT guard, CI workflow, deploy checklist | See [README.md](../README.md) + [DEPLOYMENT.md](./DEPLOYMENT.md) §0                                               |
...
├── patients
├── appointments
├── clinical         # Clinical Workflow — consultations, diagnoses, notes, vitals, follow-ups (Phase 7.1–7.4)
├── prescriptions    # Digital prescriptions + line items (Phase 7.5)
├── reports
├── notifications
└── common
```
